export function showCardIntel(card, teamId, side){
  ...
  body.style.cssText='font-size:15px;color:#ffffff;line-height:1.6;font-weight:600;';
  body.textContent=card.desc;
  
  var intel=document.createElement('div');
  intel.style.cssText='margin-top:20px;padding-top:16px;border-top:1px solid rgba(255,255,255,0.1);';
  
  var intelH=document.createElement('div');
  intelH.className='px';
  intelH.style.cssText='font-size:6px;color:#ffcc00;margin-bottom:10px;letter-spacing:1px;';
  intelH.textContent='STRATEGIC INTEL';
  
  var intelText=document.createElement('div');
  intelText.style.cssText='font-size:14px;color:#ffffff;opacity:.8;font-style:italic;';
