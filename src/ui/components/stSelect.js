...
export function showSTSelect(parent, opts) {
  ...
  hdr.style.cssText = 'text-align:center;margin-bottom:8px;flex-shrink:0;';
  hdr.innerHTML =
  ...
  explainBlock.innerHTML =
    ...
    "<div style=\"font-family:'Rajdhani';font-size:9px;color:#e03050;margin-top:6px;letter-spacing:0.5px;\">" + ctx.tip + "</div>";
  ...
  legend.innerHTML =
    "<div style=\"font-family:'Rajdhani';font-size:9px;color:#EBB010;\">\u26A1 " + (ctx.ratingExplain.primary || opts.primaryLabel) + "</div>" +
    (opts.secondaryRating && ctx.ratingExplain.secondary ? "<div style=\"font-family:'Rajdhani';font-size:9px;color:#4DA6FF;\">\u26A1 " + ctx.ratingExplain.secondary + "</div>" : '');
  ...
  sorted.forEach(function(p) {
    ...
    nameBlock.innerHTML =
      ...
      "<div style=\"font-family:'Rajdhani';font-size:9px;color:#555;\">" + (p.trait || '') + "</div>";
    ...
    r1.innerHTML = "<div style=\"font-size:11px;letter-spacing:1px;\">" + starIcons(r1Val, '#EBB010') + "</div>" +
      "<div style=\"font-family:'Rajdhani';font-weight:700;font-size:8px;color:#888;letter-spacing:1px;\">" + opts.primaryLabel + "</div>";
    ...
    if (opts.secondaryRating) {
      ...
      r2.innerHTML = "<div style=\"font-size:11px;letter-spacing:1px;\">" + starIcons(r2Val, '#4DA6FF') + "</div>" +
        "<div style=\"font-family:'Rajdhani';font-weight:700;font-size:8px;color:#888;letter-spacing:1px;\">" + (opts.secondaryLabel || '') + "</div>";
      row.appendChild(r2);
    }
