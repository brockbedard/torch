...
export function buildEndGame() {
  ...
  content.style.cssText = 'flex:1;padding:20px 16px 40px;display:flex;flex-direction:column;align-items:center;gap:16px;animation:fadeSlideUp 0.5s ease-out;';
