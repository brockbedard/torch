...
function getWeatherIcon(weather) {
  // IconScout Unicons weather pack (licensed)
  var svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="100%" height="100%"><path d="';
  if (weather === 'rain') {
    return svg + 'M8,11L8,11c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C9,11.5,8.6,11,8,11z M12,11L12,11c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C13,11.5,12.6,11,12,11z M8,17L8,17c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C9,17.5,8.6,17,8,17z M12,17L12,17c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C13,17.5,12.6,17,12,17z M21.8,9.7c-0.5-1.7-1.7-3-3.4-3.4l0,0c-1.5-3.5-5.7-5.2-9.2-3.6c-2.3,1-3.8,3.1-4.2,5.5c-2.1,0.5-3.5,2.7-2.9,4.8c0.4,1.7,1.9,2.9,3.6,3c-0.1-0.3-0.2-0.6-0.2-1v-3c0-1.4,1.1-2.5,2.5-2.5c0.8,0,1.5,0.4,2,1c0.8-1.1,2.4-1.3,3.5-0.5c0.2,0.2,0.4,0.3,0.5,0.5c0.8-1.1,2.4-1.3,3.5-0.5c0.6,0.5,1,1.2,1,2v3c0,0.3,0,0.5-0.1,0.8C21,15.1,22.6,12.3,21.8,9.7z M16,11L16,11c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C17,11.5,16.6,11,16,11z M16,17L16,17c-0.6,0-1,0.4-1,1v3c0,0.6,0.4,1,1,1s1-0.4,1-1v-3C17,17.5,16.6,17,16,17z"/></svg>';
  }
  if (weather === 'snow') {
    return svg + 'M21,11h-1.6l1.3-1.3c0.4-0.4,0.4-1,0-1.4c-0.4-0.4-1-0.4-1.4,0L16.6,11h-2.2l2.3-2.3c0.4-0.4,0.4-1,0-1.4c-0.4-0.4-1-0.4-1.4,0L13,9.6V7.4l2.7-2.7c0.4-0.4,0.4-1,0-1.4c-0.4-0.4-1-0.4-1.4,0L13,4.6V3c0-0.6-0.4-1-1-1s-1,0.4-1,1v1.6L9.7,3.3c-0.4-0.4-1-0.4-1.4,0c-0.4,0.4-0.4,1,0,1.4L11,7.4v2.2L8.7,7.3c-0.4-0.4-1-0.4-1.4,0c-0.4,0.4-0.4,1,0,1.4L9.6,11H7.4L4.7,8.3c-0.4-0.4-1-0.4-1.4,0c-0.4,0.4-0.4,1,0,1.4L4.6,11H3c-0.6,0-1,0.4-1,1s0.4,1,1,1h1.6l-1.3,1.3c-0.4,0.4-0.4,1,0,1.4c0.4,0.4,1,0.4,1.4,0c0,0,0,0,0,0L7.4,13h2.2l-2.3,2.3c-0.4,0.4-0.4,1,0,1.4c0.4,0.4,1,0.4,1.4,0c0,0,0,0,0,0l2.3-2.3v2.2l-2.7,2.7c-0.4,0.4-0.4,1,0,1.4c0.4,0.4,1,0.4,1.4,0l1.3-1.3V21c0,0.6,0.4,1,1,1s1-0.4,1-1v-1.6l1.3,1.3c0.4,0.4,1,0.4,1.4,0c0.4-0.4,0.4-1,0-1.4L13,16.6v-2.2l2.3,2.3c0.4,0.4,1,0.4,1.4,0c0.4-0.4,0.4-1,0-1.4L14.4,13h2.2l2.7,2.7c0.4,0.4,1,0.4,1.4,0c0.4-0.4,0.4-1,0-1.4L19.4,13H21c0.6,0,1-0.4,1-1S21.6,11,21,11z"/></svg>';
  }
  if (weather === 'wind') {
    return svg + 'M18.5,11h-4c-0.6,0-1,0.4-1,1s0.4,1,1,1h4c0.6,0,1,0.4,1,1s-0.4,1-1,1s-1,0.4-1,1s0.4,1,1,1c1.7,0,3-1.3,3-3S20.2,11,18.5,11z M3.5,9c0.6,0,1-0.4,1-1s-0.4-1-1-1s-1,0.4-1,1S2.9,9,3.5,9z M20.5,9c0.6,0,1-0.4,1-1s-0.4-1-1-1s-1,0.4-1,1S19.9,9,20.5,9z M7.5,9h7c1.7,0,3-1.3,3-3s-1.3-3-3-3c-0.5,0-1,0.1-1.5,0.4c-0.5,0.3-0.6,0.9-0.4,1.4c0,0,0,0,0,0c0.3,0.5,0.9,0.6,1.4,0.4c0,0,0,0,0,0C14.2,5,14.3,5,14.5,5c0.6,0,1,0.4,1,1s-0.4,1-1,1h-7c-0.6,0-1,0.4-1,1S6.9,9,7.5,9z M12.5,15h-4c-0.6,0-1,0.4-1,1s0.4,1,1,1h4c0.6,0,1,0.4,1,1s-0.4,1-1,1c-0.2,0-0.3,0-0.5-0.1c-0.5-0.3-1.1-0.2-1.4,0.3c-0.3,0.5-0.2,1.1,0.3,1.4c0,0,0,0,0.1,0c0.5,0.3,1,0.4,1.5,0.4c1.7,0,3-1.3,3-3S14.2,15,12.5,15z M4.5,15h-1c-0.6,0-1,0.4-1,1s0.4,1,1,1h1c0.6,0,1-0.4,1-1S5.1,15,4.5,15z M3.5,13h7c0.6,0,1-0.4,1-1s-0.4-1-1-1h-7c-0.6,0-1,0.4-1,1S2.9,13,3.5,13z"/></svg>';
  }
  // clear / heat → cloud + sun
  return svg + 'M17,10.5c-1.4-3-4.9-4.4-7.9-3c-1.9,0.8-3.2,2.6-3.5,4.6c-1.9,0.5-3,2.4-2.4,4.3C3.5,18,4.9,19,6.5,19h9.2c2.4,0,4.3-1.9,4.3-4.3C20,12.8,18.8,11.1,17,10.5z M22,8h-0.8c-0.1-0.5-0.3-0.9-0.5-1.3l0.5-0.5c0.4-0.4,0.4-1,0-1.4c-0.4-0.4-1-0.4-1.4,0l-0.5,0.5C18.9,5,18.5,4.8,18,4.7V4c0-0.6-0.4-1-1-1s-1,0.4-1,1v0.7c-0.5,0.1-0.9,0.3-1.4,0.6l-0.5-0.5c-0.4-0.4-1-0.4-1.4,0l0,0c-0.2,0.2-0.3,0.5-0.3,0.8c2.3,0.3,4.4,1.7,5.6,3.8c1.6,0.7,2.8,2.1,3.2,3.8c0.3-0.4,0.3-1-0.1-1.3l-0.6-0.6c0.2-0.4,0.4-0.8,0.5-1.2H22c0.6,0,1-0.4,1-1S22.6,8,22,8z"/></svg>';
}
