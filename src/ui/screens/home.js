...
var DEV_LOG = [
  "v0.17.4 — VS centered, scorebug FIRST HALF one line, reverted CPU placement (TBD), clash card text bigger, conversion play-by-play, iPhone scroll fix, play/player draft matching.",
