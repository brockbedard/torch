...
var DEV_LOG = [
  "v0.26.0 \u2014 Playtest: Tier 1-3 fixes. Rebrands: Dolphins (pink) + Spectres (ice blue). TD drama + confetti. First down slide-in. Torch card activation moment. 2-min warning slam. Card clash uses team colors. Possession screen with badges. Drive log compression. Booster skip if broke. Single-game format. Weather variation. Torch inventory tray. Player synergy indicators. Commentary attribution fix. Spike costs a down.",
