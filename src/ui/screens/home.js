...
var DEV_LOG = [
  "v0.22.1 \u2014 Phone Playtest Fixes: Clear stale commentary on possession change, 1st down distance always resets to 10, zero-yard plays use neutral color (not gold), card name auto-shrink for long names, OWN/OPP field position labels replace team abbreviations, pregame 'vs' separator between team names, Easy difficulty offense tuning (boosted completion/gain rates, reduced sack/stuff frequency), first down flash verified.",
