...
var DEV_LOG = [
  "v0.22.1 \u2014 Banded Clash pregame, gameplay cleanup, ESPN drive summary. New pregame: symmetrical banded layout with TORCH header, away/home team bands with badges + flame pips + schemes, VS collision zone, weather conditions card. Gameplay: simplified instruction text, removed TORCH pts from down/distance bar (now in banner), enlarged down/distance display, ESPN-style drive descriptions (12-yd Pass, SACK, Incomplete). Plus banner, drive summary, team logos, phone playtest fixes.",
