...
var DEV_LOG = [
  "v0.22.1 \u2014 TORCH banner, drive summary, team logos on player cards. Gold TORCH points banner with animated flame between scorebug and field. Persistent drive summary panel with play-by-play ticker, QB/RB stat lines, and live commentary. Team mascot SVG badges replace helmets on player cards. Plus phone playtest fixes: stale commentary clear, 1st down distance reset, zero-yard neutral color, card name auto-shrink, OWN/OPP field position, pregame vs separator, Easy difficulty offense tuning.",
