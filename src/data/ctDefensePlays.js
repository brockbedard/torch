...
export const CT_DEF_PLAYS = [
  {
    ...
    baseCoverage: 'cover_0', sackRateBonus: 0.08, intRateBonus: 0, runDefMod: 2,
    isCover0Blitz: true, isManCoverage: false,
    passEffect: 'Sack rate doubled vs DEEP',
    runEffect: '+3 yds for offense (gap abandoned)',
  ...
  },
  {
    ...
    runEffect: '+3 yds for offense, but -3 vs RUN fills gap',
    passMeanMod: -1, runMeanMod: 3, passCompMod: 0,
  },
  {
  ...
  },
  {
    ...
    baseCoverage: 'cover_3', sackRateBonus: 0.04, intRateBonus: 0.01, runDefMod: -1,
  ...
  },
  {
    ...
    baseCoverage: 'cover_0', sackRateBonus: 0.10, intRateBonus: -0.01, runDefMod: 2,
    isCover0Blitz: true, isManCoverage: false,
    passEffect: 'Highest sack rate. If no sack, +5 mean for offense',
    runEffect: '+3 yds for offense (gaps abandoned)',
  ...
  },
  {
    ...
    runEffect: 'OPTION plays -3 yds, edge crash contains',
    passMeanMod: 0, runMeanMod: -3, passCompMod: 0,
  },
  {
    id: 'ct_zone_blitz_drop', name: 'ZONE BLITZ DROP', cardType: 'HYBRID',
    baseCoverage: 'cover_2', sackRateBonus: 0.03, intRateBonus: 0.02, runDefMod: 0,
    isCover0Blitz: false, isManCoverage: false,
  ...
  },
  {
    ...
    baseCoverage: 'cover_1', sackRateBonus: 0.07, intRateBonus: 0, runDefMod: 1,
    ...
    passMeanMod: -2, runMeanMod: 1, passCompMod: 0,
  },
  {
    id: 'ct_prevent', name: 'PREVENT', cardType: 'ZONE',
    baseCoverage: 'cover_4', sackRateBonus: -0.04, intRateBonus: -0.01, runDefMod: 3,
    isCover0Blitz: false, isManCoverage: false,
